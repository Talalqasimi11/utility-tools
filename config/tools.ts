...
export const tools: ToolDefinition[] = [
  ...
  },
  {
    ...
    seoDescription:
      "Convert JPG images to PDF online. Combine multiple images into one PDF, choose page size and orientation, then download your document.",
  ...
  },
  {
    ...
    seoDescription:
      "Convert PDF pages to JPG images online. Select pages, choose image quality, and download your JPG files.",
    acceptedInputs: ["application/pdf"],
    multiple: false,
  },
];
